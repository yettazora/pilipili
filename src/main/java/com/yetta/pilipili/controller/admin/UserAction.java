...
public class UserAction {
	...
	@ResponseBody
	public Result save(UserInfo userInfo) throws SystemException {
	...
	@ResponseBody
	public Result uploadAvatar(MultipartFile file,@RequestParam("type") String type) throws IOException {

		InputStream inputStream=file.getInputStream();
		String imgUrl= SaveImg.save(file);
