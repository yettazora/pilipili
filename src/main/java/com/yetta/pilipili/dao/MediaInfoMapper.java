...
public interface MediaInfoMapper {
     ...
     * @return
     */
    Map<String, Object> selectByMediaId(@Param("mediaId") Integer mediaId);
     ...
     * @return
     */
    List<Integer> searchIdByKeyWord(@Param("keyWord") String keyWord);
     ...
     * @return
     */
    int countByBiaoti(@Param("biaoti") String biaoti, @Param("mediaId") Integer mediaId);
     ...
     * @param Sql
     */
    void alter(@Param("alterSql") String Sql);
     ...
     */
    int batchDelete(@Param("mediaIdArr") Integer[] mediaIdArr);
}