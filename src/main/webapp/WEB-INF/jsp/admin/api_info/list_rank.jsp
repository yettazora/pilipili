						...
						<tbody>
							<c:forEach items="${pageInfo.list}" var="entity" varStatus="status" >
								<tr>
									...
									<td>api/rank.json?apiId=${entity.id}</td>
									<td>
										<a href="rank_edit.action?id=${entity.id}&name=${entity.name}">
...
<script>
	...
	function search(pageNum) {
		...
		window.location.href = "list_user.action?pageNum="+pageNum;
	}
