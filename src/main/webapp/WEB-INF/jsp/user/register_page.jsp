						...
						<div class="login-frame-ti">
							...
							<div class="info-container">
								...
								<div class="tip-container tip-pwd-container">
									...
									<input type="password" class="txt-info txt-password" name="passWord" id="passWord"/>
								</div>
								<a id="eyeClose" href="javascript:;" onclick="eyeOpenOrClose()" class="eye-close"></a>
							</div>
							<div class="info-container">
...
<script>
	...
	function eyeOpenOrClose() {
		    if ($("#passWord").attr("type")=="password"){
		        ...
		        $("#eyeClose").removeClass("eye-close");
		        $("#eyeClose").addClass("eye-open")
			}
			else {
		        $("#passWord").attr("type","password");
                $("#eyeClose").removeClass("eye-open");
                $("#eyeClose").addClass("eye-close")
			}
    }
