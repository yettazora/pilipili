				...
				<div class="main">
					...
					<form id="form" action="" method="">
										...
										<label for="upload" style="display: inline-block; width:130px;height:130px;">
											<c:choose>
												<c:when test="${empty editUserInfo.avatar}">
													<img id="upload_avatar" src="/statics/user_avatar/f8d7dead4c7f4db9ab1aa2c8d3dc416f.png" width="100%" height="100%" />
												</c:when>
												<c:otherwise>
						...
						<div class="unit">
							...
							<div class="right">
								<input type="text" id="date1" name="registerTime" class="date" style="width: 200px;" value="${editUserInfo.registerTime}"/>
							</div>
							<!--清浮动-->
							<span class="clearfix"></span>
						</div>
						...
						<div class="unit">
							...
							<div class="right">
								<input type="text" id="date2" name="lastLoginTime" class="date" style="width: 200px;" value="${editUserInfo.lastLoginTime}"/>
							</div>
							<!--清浮动-->
							<span class="clearfix"></span>
						</div>
...
<script>
	...
	javaex.upload({
		type : "image",
		url : "${pageContext.request.contextPath}/admin/user_info/upload_image.json?type=touxiang",	// 请求路径
