...
<body>
	<div class="notfoud-container">
		...
		<div class="notfound-btn-container">
			<a class="notfound-btn" href="${pageContext.request.contextPath}/">返回首页</a>
		</div>
	</div>
</body>
</html>